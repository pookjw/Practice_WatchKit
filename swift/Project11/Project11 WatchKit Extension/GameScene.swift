...
class GameScene: SKScene {
    ...
    override func sceneDidLoad() {
        ...
        leftEdge = SKSpriteNode(color: UIColor.white, size: CGSize(width: 10, height: size.height))
        rightEdge = SKSpriteNode(color: UIColor.white, size: CGSize(width: 10, height: size.height))
        topEdge = SKSpriteNode(color: UIColor.white, size: CGSize(width: size.width, height: 10))
        bottomEdge = SKSpriteNode(color: UIColor.white, size: CGSize(width: size.width, height: 10))
        
        leftEdge.position = CGPoint(x: (-size.width / 2) + 10, y: 0)
        rightEdge.position = CGPoint(x: (size.width / 2) - 10, y: 0)
        topEdge.position = CGPoint(x: 0, y: (size.height / 2) - 10)
        bottomEdge.position = CGPoint(x: 0, y: (-size.height / 2) + 10)
        
        for edge in [leftEdge, rightEdge, topEdge, bottomEdge] as [SKSpriteNode] {
